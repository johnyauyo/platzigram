...
# user.first_name
# sino existe lanzara una excepcion 
# get solo devuelve un registro

#selecciona los usuarios con email platzi
platzi_users = User.objects.filter(email__endswith='@platzi.com')

#trae todos los usuarios
users = User.objects.all()

#actualiza los usuarios que tengan correo platzi a admin
platzi_users = User.objects.filter(email__endswith='@platzi.com').update(is_admin=True)
# por el update, devuelve un entero
